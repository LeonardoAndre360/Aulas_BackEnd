#Objetivo: Criar um programa em Python que verifica se uma pessoa pode entrar em um 
# evento com base na idade e status VIP, seguindo especificações rigorosas para 
